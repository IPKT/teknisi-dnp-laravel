...
<head>
  ...
  <!-- [Favicon] icon -->
  <link rel="icon" href="{{asset('assets')}}/images/Logo-BMKG-square.png" type="image/x-icon"> <!-- [Google Font] Family -->
  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <div class="d-flex justify-content-between align-items-center my-3">
          <img src="{{asset('assets')}}/images/Logo-BMKG-square.png" class="img-fluid" alt="logo" width="40px">              
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link"><span class="pc-micon"><i class="ti ti-wave-saw-tool"></i></span><span class="pc-mtext"> Peralatan</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="{{ route('peralatan.index') }}">ALL</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('peralatan.jenis', 'Seismometer') }}">Seismometer</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('peralatan.jenis', 'Intensitymeter Realshake') }}">Intensitymeter Realshake</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('peralatan.jenis', 'Accelero Non Colocated') }}">Accelero Non Colocated</a></li>
        ...
        <li class="pc-item">
         ...
         <li class="pc-item pc-hasmenu">
          ...
          {{-- <a href="#!" class="pc-link">
            ...
            <span class="pc-mtext">Suku Cadang</span><span class="pc-arrow"></span>
          </a> --}}
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="{{ route('sparepart.index') }}">ALL</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('sparepart.status', 'ready') }}">Ready</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('sparepart.status', 'terpasang') }}">Terpasang</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('sparepart.status', 'terkirim') }}">Terkirim</a></li>
          </ul>
        </li>
