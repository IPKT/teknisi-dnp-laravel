...
@section('content')
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            @endif
            {{-- @isset($peralatan_id) --}}
            <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#downloadModal">
                    Download
                </a></li>
            {{-- @endisset --}}
            @empty($peralatan_id)
...
<div class="card shadow-sm">
    <div class="card-body">
        @foreach ($hardwares as $jenis => $hardware)
            <h4 class="mt-4">{{ $jenis }}</h4>
            <div class="table-responsive">
                <table id="hardware-table-{{ \Str::slug($jenis) }}" class="table table-bordered table-hover">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="#"
                                                        class="dropdown-item btn-delete-hardware small py-1"
                                                        data-id="{{ $s->id }}"
