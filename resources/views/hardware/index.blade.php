                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <li class=""><a href="#" class="dropdown-item btn-edit-hardware small py-1" data-id="{{$s->id}}">Edit</a></li>
                                            <li><a href="#" class="dropdown-item btn-delete-hardware small py-1" data-id="{{$s->id}}">Hapus</a></li>
                                            </ul>
                                        </div>
                                    </td>     
                                </tr>
    ...
    btn.addEventListener('click', function () {
        ...
        fetch(`/hardware/${id}`)
            ...
            .then(data => {
                ...
                document.getElementById('edit-hardware-jenis-barang').value = data.jenis_barang;
                document.getElementById('edit-hardware-jenis-peralatan').value = data.jenis_peralatan;
                document.getElementById('edit-hardware-tahun-masuk').value = data.tahun_masuk;
                document.getElementById('edit-hardware-tanggal-masuk').value = data.tanggal_masuk;
                document.getElementById('edit-hardware-merk').value = data.merk;
                document.getElementById('edit-hardware-tipe').value = data.tipe;
                document.getElementById('edit-hardware-serial-number').value = data.serial_number;
                document.getElementById('edit-hardware-sumber-pengadaan').value = data.sumber_pengadaan;
                document.getElementById('edit-hardware-status').value = data.status;
                document.getElementById('edit-hardware-tanggal-keluar').value = data.tanggal_keluar;
                document.getElementById('edit-hardware-lokasi-pemasangan').value = data.lokasi_pemasangan;
                document.getElementById('edit-hardware-lokasi-pengiriman').value = data.lokasi_pengiriman;
                ...
                // document.getElementById('edit-hardware-status').value = data.status;
                const statusHardwareEdit = document.getElementById('edit-sardware-status').value;
                const inputTanggalKeluar = document.getElementById('edit-sardware-tanggal-keluar');
                const divTanggalKeluar = document.getElementById('divTanggalKeluarEdit');
                const inputLokasiPengiriman = document.getElementById('edit-sardware-lokasi-pengiriman');
                const divLokasiPengiriman = document.getElementById('divLokasiPengirimanEdit');
                const inputLokasiPemasangan = document.getElementById('edit-sardware-lokasi-pemasangan');
