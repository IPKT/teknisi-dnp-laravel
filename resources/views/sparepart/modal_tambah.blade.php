<div class="modal fade" id="modalTambahSparepart" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <form id="formTambahSparepart" method="POST" enctype="multipart/form-data">
          @csrf
        ...
        <div class="modal-body">
          ...
          <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" name="jenis_barang" list="listJenisBarang" class="form-control" required>
              ...
              <div class="col-md-6">
                ...
                <input type="file" name="berkas" class="form-control" accept="application/pdf, .jpg, .jpeg, .png, .webp">
            </div>
              <div class="col-md-6">
