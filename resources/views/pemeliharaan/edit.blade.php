                    ...
                    <div class="row g-3">
                            ...
                            <select name="id_peralatan" class="form-select" required>
                                ...
                                @foreach ($peralatans as $alat)
                                    <option value="{{ $alat->id }}"
                                        {{ $alat->id == $pemeliharaan->id_peralatan ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="kondisi_awal" class="form-select">
                                <option {{ $pemeliharaan->kondisi_awal == 'ON' ? 'selected' : '' }} value="ON">ON
                                </option>
                                <option {{ $pemeliharaan->kondisi_awal == 'OFF' ? 'selected' : '' }} value="OFF">OFF
                                </option>
                            </select>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="jenis_pemeliharaan" class="form-select">
                                ...
                                <option {{ $pemeliharaan->jenis_pemeliharaan == 'PM' ? 'selected' : '' }} value="PM">
                                    Preventive Maintenance</option>
                                <option {{ $pemeliharaan->jenis_pemeliharaan == 'CM' ? 'selected' : '' }} value="CM">
                                    Corrective Maintenance</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea class="form-control textAreaMultiline my-text-area" name="rekomendasi" rows="3" placeholder="1.  \n2. "
                                required>{{ $pemeliharaan->rekomendasi }}</textarea>
                        </div>
                        <div class="col-md-4">
                            <label>Kerusakan</label>
                            <input type="text" name="kerusakan" class="form-control"
                                value="{{ $pemeliharaan->kerusakan }}">
                        </div>
                        <div class="col-md-6">
                            <label>Laporan WA</label>
                            <textarea class="form-control textAreaMultiline" name="text_wa" rows="5" placeholder="copy laporan di WA Grup">{{ $pemeliharaan->text_wa }}</textarea>
                        </div>

                        <div class="col-md-6">
                            <label>Catatan Pemeliharaan</label>
                            <textarea name="catatan_pemeliharaan" rows="3" class="form-control"
                                placeholder="Masukan kegiatan atau kondisi yang dianggap penting">{{ $pemeliharaan->catatan_pemeliharaan }}</textarea>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            @if ($pemeliharaan->laporan)
                                <p><a href="{{ asset('storage/uploads/laporan_pemeliharaan/' . $pemeliharaan->laporan) }}"
                                        target="_blank">📄 Lihat Laporan 1</a></p>
                            @endif
                        ...
                        <div class="col-md-4">
                            ...
                            @if ($pemeliharaan->laporan2)
                                <p><a href="{{ asset('storage/uploads/laporan_pemeliharaan/' . $pemeliharaan->laporan2) }}"
                                        target="_blank">📄 Lihat Laporan 2</a></p>
                            @endif
                        </div>
