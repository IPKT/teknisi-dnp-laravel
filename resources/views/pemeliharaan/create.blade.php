           ...
           <form action="{{ route('pemeliharaan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                       ...
                       <textarea class="form-control textAreaMultiline my-text-area" name="rekomendasi" rows="3" placeholder="1. Perlu.. \n2. Perlu.." required></textarea>
                    </div>
                    <div class="col-md-6">
                        <label>Kerusakan</label>
                        <input type="text" name="kerusakan" class="form-control" placeholder="UPS, Sensor, Digitizer">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="catatan_pemeliharaan" rows="3" class="form-control" placeholder="Masukan kegiatan atau kondisi yang dianggap penting"></textarea>
                    </div>
                    <div class="col-md-6">
