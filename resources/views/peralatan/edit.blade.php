        ...
        <form action="{{ route('peralatan.update', $peralatan->id) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="koordinat" class="form-control" value="{{ $peralatan->koordinat }}" required>
                </div>
                    <div class="col-md-1">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="detail_lokasi" class="form-control" value="{{ $peralatan->detail_lokasi }}">
                </div>
                {{-- <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="jabatan_pic" class="form-control" value="{{ $peralatan->jabatan_pic }}">
                </div>
                <div class="col-md-4">
